# language: pt
# encoding: utf-8
Funcionalidade: MINC_MAPAS_7.0_EPE05_005_Contato
  ...
  **PARA** contatar responsáveis por um agente
  ...
  Cenário: 01. Contato - Enviar Mensagem
    ...
    E preencha os <Campos>
      ...
      | Tipo                               | Sugestão                                                                                                              |
      | Mensagem                           | Melhorar a apresentação inicial do agente para os indivíduos que não possuem conhecimento específico acerca do tema.  |
      | Enviar a mensagem de forma anônima | -                                                                                                                     |
      | Receber cópia da mensagem          | -                                                                                                                     |
      | Enviar somente para o responsável  | -                                                                                                                     |
    ...
    E envia o [E-mail-19](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_E-mail/19) para o(s) **agente(s) relacionado(s) ao agente** conforme a [RNG-26](#/scenario/Regras_de_Negócio_MINC_MAPAS_7.0_Regras_Negócio/26)
  ...
  Cenário: 05. Contato - Enviar a mensagem de forma anônima - Enviar Mensagem
    ...
    Quando o usuário aciona a opção **Enviar Mensagem**
    Então o sistema exibe a [MSG-19](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_Mensagens_de_Interface/19)
    E envia o [E-mail-20](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_E-mail/20) para o(s) **agente(s) relacionado(s) no agente** conforme a [RNG-26](#/scenario/Regras_de_Negócio_MINC_MAPAS_7.0_Regras_Negócio/26)
  ...
  Cenário: 08. Contato - Receber cópia da mensagem
    ...
    Quando o usuário aciona a opção **Enviar Mensagem**
    Então o sistema exibe a [MSG-19](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_Mensagens_de_Interface/19)
    E envia o [E-mail-19](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_E-mail/19) para o(s) **agente(s) relacionado(s) no agente** conforme a [RNG-26](#/scenario/Regras_de_Negócio_MINC_MAPAS_7.0_Regras_Negócio/26)
    E envia o [E-mail-19](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_E-mail/19) para o **usuário remetente**

  Cenário: Protótipo
  ![Image](MINC_MAPAS_7.0_EPE05_005_Contato_1.png)
  ![Image](MINC_MAPAS_7.0_EPE05_005_Contato_2.png)
  ![Image](MINC_MAPAS_7.0_EPE05_005_Contato_Anonimo_1.png)
  ![Image](MINC_MAPAS_7.0_EPE05_005_Contato_Anonimo_2.png)
