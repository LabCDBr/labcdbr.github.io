# language: pt
# encoding: utf-8
Funcionalidade: MINC_MAPAS_7.0_EPE04_004_Denunciar
  ...
  **PARA** denunciar irregularidades em uma oportunidade
  ...
  Cenário: 01. Denúncia - Enviar Denúncia
    ...
    E preencha os <Campos>
      ...
      | Mensagem                           | Diante das irregularidades na oportunidade em questão, é imperativo denunciarmos para garantir a integridade dos recursos e a transparência na gestão. Foram identificadas falhas e desvios durante os processos de apresentação da oportunidade. |
      | Enviar a denúncia de forma anônima | -                                                                                                                                                                                                                                                 |
      | Receber cópia da mensagem          | -                                                                                                                                                                                                                                                 |
    ...
    E envia o [E-mail-11](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_E-mail/11) para o(s) **usuário(s) responsável(veis) pela oportunidade**
  ...
  Cenário: 05. Denúncia - Enviar denúncia de forma anônima - Enviar Denúncia
    ...
    Quando o usuário aciona a opção **Enviar Denúncia**
    Então o sistema exibe a [MSG-19](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_Mensagens_de_Interface/19)
    E envia o [E-mail-12](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_E-mail/12) para o(s) **usuário(s) responsável(veis) pela oportunidade**
  ...
  Cenário: 08. Denúncia - Receber cópia da mensagem
    ...
    Então o sistema exibe a [MSG-19](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_Mensagens_de_Interface/19)
    E envia o [E-mail-11](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_E-mail/11) para o(s) **usuário(s) responsável(veis) pela oportunidade**
    E envia o [E-mail-11](#/scenario/Mensagem_de_Interface_MINC_MAPAS_7.0_E-mail/5) para o **usuário denunciante**

  Cenário: Protótipo
  ![Image](MINC_MAPAS_7.0_EPE04_004_Denunciar.png)
  ![Image](MINC_MAPAS_7.0_EPE04_004_Denunciar_Anonimo.png)
